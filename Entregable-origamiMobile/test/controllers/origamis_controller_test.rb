...
class OrigamisControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create origami" do
    assert_difference('Origami.count') do
      post origamis_url, params: { origami: { categoria: @origami.categoria, dificultad: @origami.dificultad, imagen: @origami.imagen, name: @origami.name } }
    end
  ...
  test "should update origami" do
    patch origami_url(@origami), params: { origami: { categoria: @origami.categoria, dificultad: @origami.dificultad, imagen: @origami.imagen, name: @origami.name } }
